...
var require_flat = _chunk4R4UQZRTjs.__commonJS.call(void 0, {
...
// src/cli-main.ts
_chunk4R4UQZRTjs.init_cjs_shims.call(void 0, );
var import_flat = _chunk4R4UQZRTjs.__toModule.call(void 0, require_flat());
var _fs = require('fs');
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    Object.assign(options, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, flags));
    if (files.length > 0) {
      options.entry = files.map(_chunk4R4UQZRTjs.slash);
    }
    if (flags.format) {
