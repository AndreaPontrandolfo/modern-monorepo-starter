...
_chunk4R4UQZRTjs.__export.call(void 0, colorette_exports, {
  bgBlack: () => bgBlack,
...
var none = (any) => any;
var createColors = ({ useColor = isColorSupported } = {}) => useColor ? colors : Object.keys(colors).reduce((colors2, key) => _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, colors2), { [key]: none }), {});
var {
  reset,
  bold,
  dim,
