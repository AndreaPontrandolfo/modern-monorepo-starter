...
var require_string_argv = _chunk4R4UQZRTjs.__commonJS.call(void 0, {
...
var require_consola = _chunk4R4UQZRTjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunk4R4UQZRTjs.__require.call(void 0, "util"));
    var e = _chunk4R4UQZRTjs.__require.call(void 0, "path");
    var t = _chunk4R4UQZRTjs.__require.call(void 0, "fs");
    var r = u(_chunk4R4UQZRTjs.__require.call(void 0, "os"));
    var n = u(_chunk4R4UQZRTjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var _ = class {
      constructor(u2 = {}) {
        ...
        for (const u3 in this._types) {
          const D2 = _chunk4R4UQZRTjs.__spreadValues.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, { type: u3 }, this._types[u3]), this._defaults);
      ...
      _logFn(u2, D2, e2) {
        ...
        const r2 = (u3 = false) => {
          ...
          if (this._lastLog && D3 > 0) {
            ...
            D3 > 1 && u4.push(`(repeated ${D3} times)`), this._log(_chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, this._lastLog), { args: u4 })), this._lastLogCount = 1;
          }
          if (u3) {
    ...
    }, _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, _u), { level: { enumerable: true, get() {
    ...
    var Gu = typeof __non_webpack_require__ != "undefined" ? __non_webpack_require__ : _chunk4R4UQZRTjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
...
var import_string_argv = _chunk4R4UQZRTjs.__toModule.call(void 0, require_string_argv());
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async (file) => {
        const loadConfig = _chunk4R4UQZRTjs.__require.call(void 0, "postcss-load-config");
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins || plugins.length > 0) {
          const postcss = _chunk4R4UQZRTjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, options), { from: args.path })));
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunk4R4UQZRTjs.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunk4R4UQZRTjs.__toModule.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunk4R4UQZRTjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => ({
        path: _chunk4R4UQZRTjs.__require.resolve(args.path, { paths: [args.resolveDir] }),
        namespace: "node-file"
      }));
...
async function runEsbuild(options, {
  ...
  const pkg = await _chunkPE4LX7EXjs.loadPkg.call(void 0, process.cwd());
  ...
  const env = _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, options.env);
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      loader: _chunk4R4UQZRTjs.__spreadValues.call(void 0, {
        ".aac": "file",
        ".css": "file",
        ".eot": "file",
        ".flac": "file",
      ...
      plugins: esbuildPlugins.filter(_chunk4R4UQZRTjs.truthy),
      define: _chunk4R4UQZRTjs.__spreadValues.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, format === "cjs" && injectShims ? {
...
var isJS = (path7) => /\.(js|mjs|cjs)$/.test(path7);
var isCSS = (path7) => /\.css$/.test(path7);
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunk4R4UQZRTjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkNK5HUMBWjs.PrettyError)("@swc/core is required for es5 target. Please install it with `npm install @swc/core -D`");
      }
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkPE4LX7EXjs.reportSize.call(void 0, this.logger, this.format, writtenFiles.reduce((res, file) => {
        return _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, res), {
          [file.name]: file.size
        });
      }, {}));
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  var _a, _b, _c, _d;
  const _options = _chunk4R4UQZRTjs.__spreadValues.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, optionsFromConfigFile), optionsOverride);
  const options = _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {
    target: "node12",
    format: ["cjs"],
    outDir: "dist"
  }, _options), {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkNK5HUMBWjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkNK5HUMBWjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkNK5HUMBWjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkNK5HUMBWjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  return options;
};
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkPE4LX7EXjs.loadTsupConfig.call(void 0, process.cwd());
  ...
  await Promise.all([...Array.isArray(configData) ? configData : [configData]].map(async (item) => {
    var _a;
    const logger = _chunkPE4LX7EXjs.createLogger.call(void 0, item == null ? void 0 : item.name);
    ...
    if (options.dts) {
      ...
      worker.postMessage({
        ...
        options: _chunk4R4UQZRTjs.__spreadProps.call(void 0, _chunk4R4UQZRTjs.__spreadValues.call(void 0, {}, options), {
    ...
    if (!((_a = options.dts) == null ? void 0 : _a.only)) {
      ...
      const debouncedBuildAll = _chunk4R4UQZRTjs.debouncePromise.call(void 0, () => {
        return buildAll();
      }, 100, _chunkNK5HUMBWjs.handleError);
      const buildAll = async () => {
        ...
        if (options.clean) {
          ...
          await _chunk4R4UQZRTjs.removeFiles.call(void 0, ["**/*", "!**/*.d.ts", ...extraPatterns], options.outDir);
      ...
      const startWatcher = async () => {
        ...
        const watchPaths = typeof options.watch === "boolean" ? "." : Array.isArray(options.watch) ? options.watch.filter((path7) => typeof path7 === "string") : options.watch;
        ...
        watcher.on("all", (type, file) => {
          file = _chunk4R4UQZRTjs.slash.call(void 0, file);
